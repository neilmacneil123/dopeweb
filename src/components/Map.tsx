...
const ownerGradients: Record<TerritoryOwner, string> = {
  You: "from-emerald-500/70 via-emerald-600/70 to-emerald-700/70",
  Rival: "from-rose-500/70 via-rose-600/70 to-rose-700/70",
  Neutral: "from-slate-600/60 via-slate-700/60 to-slate-800/60",
};

const ownerCopy: Record<TerritoryOwner, string> = {
  You: "Your crew holds this turf.",
  Rival: "Another crew holds this turf.",
  Neutral: "No one runs this turf yet.",
};

export function Map({ currentCity, territories, onTravel, onCapture, onDefend }: MapProps) {
  return (
    <div className="rounded-xl border border-slate-800 bg-slate-900/70 p-4 text-slate-100">
      <div className="mb-4 flex items-center justify-between">
        ...
        <div className="hidden text-xs text-slate-400 sm:flex sm:flex-col sm:items-end">
          ...
          <span className="flex items-center gap-2"><span className="h-2 w-2 rounded-full bg-rose-400" /> Rival</span>
